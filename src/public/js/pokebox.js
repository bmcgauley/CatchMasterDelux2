import { getGameSpecificPokemon, createPokemonElement, getPokemonDetails, showPokemonDetails } from './pokedexService.js';
import { updateFirestorePokemonStatus, scheduleFirestoreUpdate, pendingUpdates, syncWithFirestore } from './firestore.js';
...
export { currentGameId, handlePokemonStatusChange, gameSpecificPokemon };
